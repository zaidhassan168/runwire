...
export default function Home() {
  ...
  const runJourney = useCallback(async () => {
    ...
    try {
      ...
      return results;
    } catch (error) { setRequestError(error instanceof Error ? error.message : 'Journey failed.'); return []; }
